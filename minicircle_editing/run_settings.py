...
min_grnas_subsequent = 2  # how many gRNAs to investigate with partially edited sequences
max_grnas_subsequent = 5
guides_to_cofold = 100 # number of guides to send to RNAcofold during gRNA selection step
...
mismatch_threshold_anchor = 1  # no. of mismatches allowed when identifying gRNA anchors
mismatch_threshold_editing = 2  # no. of mismatches allowed during editing before node becomes leaf
editing_window = 3  # no. of mRNA bases beyond current bp to include in RNAcofold
